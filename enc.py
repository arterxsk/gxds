...
def MainMenu():
    try:
        ...
        output = file.lower().replace('.py', '') + '_gxds.py'
        if option == 16:
            SEncode(data,output)
        else:
